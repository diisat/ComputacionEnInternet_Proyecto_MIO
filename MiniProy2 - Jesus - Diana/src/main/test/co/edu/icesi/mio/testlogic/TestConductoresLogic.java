...
assertTrue(conductorLogic.actualizarConductor(conductor));
   ...
   /**
	...
	/**
	 * Funciona, no busca la cedula "", porque no es vï¿½lida
	 */
	@Test
	...
	/**
	 * Funciona, no busca la cedula "klj", porque no es vï¿½lida
	 */
	@Test
	...
	/**
	 * Funciona, no encuentra la cedula "1456", porque no creï¿½ en la base de datos
	 */
	@Test
	...
	/**
	 * Funciona, no busca la cedula "45f87exaDD", porque no es vï¿½lida
	 */
	@Test
	...
	/**
	 * Funciona, no encuentra los apellidos "12jjf" porque no son vï¿½lidos
	 */
	@Test
